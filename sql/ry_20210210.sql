...
-- 25、心理评测结果表
-- ----------------------------
DROP TABLE IF EXISTS subjet_score;
CREATE TABLE subjet_score (
    score_id  bigint(20)      not null auto_increment      comment '编号',
    PatientCode	        varchar (50)	         comment  '体检代码 ',
    IDCardNo	        varchar (30)	         comment  '身份证号 ',
    PatientName	        varchar (30)	         comment  '姓名 ',
    Input_Code	        varchar (8)	             comment  '输入码 ',
    ...
    Education	        varchar (20)	         comment  '教育 ',
    Occupation	        varchar (20)	         comment  '职业 ',
    score int(11)                                          comment '总分数',
    genre1_score int(11)                                   comment '身体疲劳类总分数',
    genre2_score int(11)                                   comment '关系敏感类总分数',
    genre3_score int(11)                                   comment '郁闷程度类总分数',
    genre4_score int(11)                                   comment '焦虑程度类总分数',
    genre5_score int(11)                                   comment '紧张反应类总分数',
    genre6_score int(11)                                   comment '工作-家庭冲突类总分数',
    genre1 int(11)                                         comment '身体疲劳类因子分',
    genre2 int(11)                                         comment '关系敏感类因子分',
    genre3 int(11)                                         comment '郁闷程度类因子分',
    genre4 int(11)                                         comment '焦虑程度类因子分',
    genre5 int(11)                                         comment '紧张反应类因子分',
    genre6 int(11)                                         comment '工作-家庭冲突类因子分',
    genre_name varchar(50)                                 comment '总级别',
    genre1_name varchar(50)                                comment '身体疲劳级别',
    genre2_name varchar(50)                                comment '关系敏感级别',
    genre3_name varchar(50)                                comment '郁闷程度级别',
    genre4_name varchar(50)                                comment '焦虑程度级别',
    genre5_name varchar(50)                                comment '紧张反应级别',
    genre6_name varchar(100)                               comment '工作-家庭冲突级别',
    genre1des varchar(100)                                 comment '身体疲劳级别描述',
    genre2des varchar(100)                                 comment '关系敏感级别描述',
    genre3des varchar(100)                                 comment '郁闷程度级别描述',
    genre4des varchar(100)                                 comment '焦虑程度级别描述',
    genre5des varchar(100)                                 comment '紧张反应级别描述',
    genre6des varchar(100)                                 comment '工作-家庭冲突级别描述',
    create_by        varchar(64)     default ''           comment '创建者',
    create_time      datetime                             comment '创建时间',
    update_by        varchar(64)     default ''           comment '更新者',
    update_time      datetime                             comment '更新时间',
    subjet1 int(11)                                        comment '第1题',
    subjet2 int(11)                                        comment '第2题',
    subjet3 int(11)                                        comment '第3题',
    subjet4 int(11)                                        comment '第4题',
    subjet5 int(11)                                        comment '第5题',
    subjet6 int(11)                                        comment '第6题',
    subjet7 int(11)                                        comment '第7题',
    subjet8 int(11)                                        comment '第8题',
    subjet9 int(11)                                        comment '第9题',
    subjet10 int(11)                                       comment '第10题',
    subjet11 int(11)                                       comment '第11题',
    subjet12 int(11)                                       comment '第12题',
    subjet13 int(11)                                       comment '第13题',
    subjet14 int(11)                                       comment '第14题',
    subjet15 int(11)                                       comment '第15题',
    subjet16 int(11)                                       comment '第16题',
    subjet17 int(11)                                       comment '第17题',
    subjet18 int(11)                                       comment '第18题',
    subjet19 int(11)                                       comment '第19题',
    subjet20 int(11)                                       comment '第20题',
    subjet21 int(11)                                       comment '第21题',
    subjet22 int(11)                                       comment '第22题',
    subjet23 int(11)                                       comment '第23题',
    subjet24 int(11)                                       comment '第24题',
    subjet25 int(11)                                       comment '第25题',
    subjet26 int(11)                                       comment '第26题',
    subjet27 int(11)                                       comment '第27题',
    subjet28 int(11)                                       comment '第28题',
    subjet29 int(11)                                       comment '第29题',
    subjet30 int(11)                                       comment '第30题',
    subjet31 int(11)                                       comment '第31题',
    subjet32 int(11)                                       comment '第32题',
    subjet33 int(11)                                       comment '第33题',
    subjet34 int(11)                                       comment '第34题',
    subjet35 int(11)                                       comment '第35题',
    subjet36 int(11)                                       comment '第36题',
    subjet37 int(11)                                       comment '第37题',
    subjet38 int(11)                                       comment '第38题',
    subjet39 int(11)                                       comment '第39题',
    subjet40 int(11)                                       comment '第40题',
    subjet41 int(11)                                       comment '第41题',
    subjet42 int(11)                                       comment '第42题',
    subjet43 int(11)                                       comment '第43题',
    subjet44 int(11)                                       comment '第44题',
    subjet45 int(11)                                       comment '第45题',
    subjet46 int(11)                                       comment '第46题',
    subjet47 int(11)                                       comment '第47题',
    subjet48 int(11)                                       comment '第48题',
    subjet49 int(11)                                       comment '第49题',
    subjet50 int(11)                                       comment '第50题',
    primary key (score_id)
) engine=innodb auto_increment=1 comment = '心理评测结果表';


-- ----------------------------
-- 26、三类人员统计表
-- ----------------------------
DROP TABLE IF EXISTS ecg_threeType;
CREATE TABLE ecg_threeType(
   threeType_id  bigint(20)      not null auto_increment      comment '编号',
   year  int(10)                                              comment '年份',
   one   int(10)                                              comment '一类',
   two   int(10)                                              comment '二类',
   three int(10)                                              comment '三类',
   create_by        varchar(64)     default ''           comment '创建者',
   create_time      datetime                             comment '创建时间',
   update_by        varchar(64)     default ''           comment '更新者',
   update_time      datetime                             comment '更新时间',
   primary key (threeType_id)
)engine=innodb auto_increment=1 comment = '三类人员统计表';
-- ----------------------------
-- 26、异常结果统计表
-- ----------------------------
DROP TABLE IF EXISTS ecg_positive;
CREATE TABLE ecg_positive
(
    threeType_id bigint(20) not null auto_increment comment '编号',
    year         int(10) comment '年份',
    overweight   int(10) comment '超重',
    hypertension int(10) comment '高血压',
    tg           int(10) comment '甘油三酯增高',
    tc           int(10) comment '总胆固醇增高',
    glu          int(10) comment '高血糖',
    ldl_c        int(10) comment '低密度脂蛋白增高',
    ggt          int(10) comment '谷氨酰转酞酶增高',
    alt          int(10) comment '谷丙转氨酶增高',
    fatty_live   int(10) comment '脂肪肝（轻度）',
    create_by    varchar(64) default '' comment '创建者',
    create_time  datetime               comment '创建时间',
    update_by    varchar(64) default '' comment '更新者',
    update_time  datetime               comment '更新时间',
    primary key (threeType_id)
)engine=innodb auto_increment=1 comment = '异常结果统计表';
